...
export interface AuraConfig {
  ...
  /** Hermes API endpoint */
  hermesUrl: string;
  /** Runtime bridge transport override */
  bridgeMode?: 'legacy' | 'custom';
  /** Optional endpoint used when bridgeMode='custom' */
  bridgeUrl?: string;
  /** Optional namespace for custom transport */
  bridgeNamespace?: string;
  /** Poll interval when custom transport uses browser polling fallback */
  bridgePollMs?: number;
